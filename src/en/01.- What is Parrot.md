...
The system has its own applications repository including all the packages supported by Debian, plus many other applications and tools Debian can't provide yet, but all of them are accessible directly from the APT package manager.
