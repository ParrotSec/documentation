...
Parrot includes the latest nvidia driver

This version only supports GeForce, Quadro, NVS, Tesla, etc... GPUs based on the
...
how to install it
<code>
sudo apt update && sudo apt install nvidia-legacy-340.xx-driver
</code>
